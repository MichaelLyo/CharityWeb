...
<html>
<head>
    <title>Generous a Charity Category Flat Bootstarp Resposive Website Template | Blog :: w3layouts</title>
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
    ...
    <!-- Custom Theme files -->
    <link href="../assets/css/participateStyle.css" rel='stylesheet' type='text/css' />
        ...
        <div class="navbar-wrapper">
            ...
            <nav class="animenu">
                ...
                <ul class="animenu__nav">
                    ...
                    <li>
                        <a href="hotspot-index.jsp">在参与</a>
                    </li>
...
<div class="footer text-center">
    <div class="container">
        ...
        <div class="copy">
            <p>&copy; 2015 Generous. All Rights Reserved | Design by <a href="http://w3layouts.com/">W3layouts</a> </p>
        </div>
        <!--footer-->
    </div>
</div>
