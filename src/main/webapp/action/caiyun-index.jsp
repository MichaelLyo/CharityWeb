        ...
        <div class="col-md-9 technology-left">
            <div class="tech-no">
                ...
                <div class="tc-ch wow fadeInDown"  data-wow-duration=".8s" data-wow-delay=".2s">
                    ...
                    <div class="tch-img">
                        <img src="../assets/img/caiyun-participate.jpg" style="width:1000px;height:450px;">
                    </div>

                    <h3>彩  云  支  南</h3>
                    <h6>上海市同济大学彩云支南公益协会 云南省青基会“彩云支南公益团队”同济分会
                    </h6>
                    <p>了解公益理念，传播公益思想。同心者同行，彩云支南，圆你一个公益梦！</p>
                    <p>致力于搭建同济大学与云南地区沟通交流的公益平台。通过丰富的活动，让同济学子应用自己的专业知识或特长帮助云南乡村进入更多人视野，得到更多关注。</p>
                ...
                <div class="wthree">
                    ...
                    <div class="col-md-6 wthree-right wow fadeInDown"  data-wow-duration=".8s" data-wow-delay=".2s">
                        <h3><a href="../Login/userInfo.jsp">Lorem Ipsum is simply</a></h3>
                        <h6>BY <a href="activity.jsp">ADAM ROSE </a>JULY 10 2016.</h6>
                        <p>Ut enim ad minim veniam, quis nostrud eiusmod tempor incididunt ut labore et dolore magna aliqua exercitation ullamco laboris .</p>
                        <div class="bht1">
                            <a href="activity.jsp">了解更多</a>
                        </div>
